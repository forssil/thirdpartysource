...
public:
	...
	// Added by Keil, 2015-3-13, used to reset some member variable.
...
class CAsyncIo
{
	...
	// Added by Keil, 2015-3-13, used as a signal to judge whether CAsyncOutputPin::Request() be called or not 
	BOOL m_bStartAsyncRead;
	BOOL m_bCanNotCreateThread;
